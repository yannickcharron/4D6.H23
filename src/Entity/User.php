...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: ItemInventory::class, orphanRemoval: true)]
    ...
    /**
     * @return Collection<int, ItemInventory>
     */
    ...
    public function addInventory(ItemInventory $inventory): self
    {
    ...
    public function removeInventory(ItemInventory $inventory): self
    {
